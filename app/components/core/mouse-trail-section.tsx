...
import ImageMouseTrail from '~/components/core/image-mouse-trail';
...
export const MouseTrailSection = () => {
    return (
        <section>
            <ImageMouseTrail
                items={images}
            ...
            >
                <article className='relative z-50 mix-blend-difference '>
                    ...
                    <p className='text-sm font-semibold my-4 text-center'>Hover to feel me</p>
                </article>
            </ImageMouseTrail>
        </section>
    );
